...
namespace NetShip.Migrations
{
    ...
    [Migration("20240428212507_LandingEventsAdded2")]
    partial class LandingEventsAdded2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NetShip.Entities.LandingUserEvent", b =>
                {
                    b.OwnsOne("NetShip.Entities.EventDetails", "Details", b1 =>
                        {
                            b1.Property<Guid>("LandingUserEventUserId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("LandingUserEventUserId");

                            b1.ToTable("LandingUserEvents", "MasterBase");

                            b1.WithOwner()
                                .HasForeignKey("LandingUserEventUserId");
                        });
